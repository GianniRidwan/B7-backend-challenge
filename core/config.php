...
define('DB_NAME', 'backend'); // Wat is de database naam
...
define('DEFAULT_CONTROLLER', 'backend'); 			// Dit is de standaard controller waarmee de webapplictie wordt opgestart
